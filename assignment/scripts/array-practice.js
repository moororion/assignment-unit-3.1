...
let favoriteFoods = ["Pizza", "Asada", "Chicken",];
...
console.log("Number of my favorite foods are ", numberOfFoods);
...
console.log("The ", lastAnimal, " of the list of ", animalArray, " is...");
...
console.log("Added dersert to my list of favorite foods: ", favoriteFoods);
...
let entree = "Taco La lengua"
favoriteFoods.unshift(entree)
console.log('Added more food to the beginning: ${animalArray}');
